...
namespace TODOAdaptiveUISample.Views
{
    public sealed partial class MainPage : Page
    {
        ...
        {
            // Set the data context of the inline viewer to the selected item
        ...
        protected override void OnNavigatedFrom(NavigationEventArgs e)
        {
            if (e.NavigationMode == NavigationMode.New)
            {
                ...
                {
                    ApplicationData.Current.LocalSettings.Values["ForwardID"] = e.Parameter;
                }                   
            }
        }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                if (ApplicationData.Current.LocalSettings.Values.ContainsKey("ForwardID"))
                {
                    string ID = ApplicationData.Current.LocalSettings.Values["ForwardID"].ToString();
                    this.ViewModel.SelectedItem = this.ViewModel.ItemVMs.Single(i => i.TodoItem.Id == ID);

                    ApplicationData.Current.LocalSettings.Values.Remove("ForwardID");
                }
            }
        }
        ...
        {
            DropBackground.Visibility = Visibility.Collapsed;
