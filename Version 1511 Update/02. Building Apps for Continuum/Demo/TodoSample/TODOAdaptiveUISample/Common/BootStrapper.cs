...
namespace TODOAdaptiveUISample.Common
{
    ...
    {
        // TODO: To use the notification features of this demo, you will need to reserve a name for your app with the
        // Store.You will need to create a Notification Hub in Azure and insert the connection string and the hubPath into the variables below
        // and then uncomment the code below the coment Hook up notifications, towards the end of the InternalLaunchAsync method
        ...
        private async void InternalLaunchAsync(ILaunchActivatedEventArgs e)
        {
            ...
            {
                if (ex.HResult != -2147023674) // Network not available
                    throw;
            }
